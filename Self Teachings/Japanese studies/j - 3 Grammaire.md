...
>décliner un nom ou un adjectif au passé ou au négatif pour exprimer le fait que 
>quelque chose n'est pas \[X] ou bien était \[X].

Ce n'est pas exactement l'accord en genre et en nombre français car :
1. Le reste de la phrase n'est pas accordé
2. Il n'y a pas de réel accord en japonais, ceci est différent des accords
...
<mark class=purple>Exemple</mark>
{学|がく}{生|せい} ${\color{crimson}\to}$ 学生じゃない
<small>étudiant -> n'est pas étudiant</small>
...
<small>ami -> était ami</small>
元気 ${\color{crimson}\to}$ 元気じゃなかった
<small>bien -> n'était pas bien</small>
...
<mark class=red><big><big>⚠</big></big></mark> La particule de thème n'est <b>PAS</b> le verbe "être", et n'indique <b>PAS</b> le sujet, elle indique le <span style="color:gold">thème </span>

Une traduction possible est : "Quant à \*thème\*"
Une fois que le thème est établi dans une conversation, il est commun qu'il soit induit dans le reste de celle ci.

<mark class=purple>Exemple</mark>

アリス：{今日|きょう}は{試|し}{験|けん}だ。
...
---
Dans la 3$^{e}$ phrase, "ジョンは" est implicite car le thème a été fixé précédemment,
...
アリス：うん、トム<mark class=red>も</mark>学生じゃない。 

La 2$^{e}$ phrase est <u>incorrecte</u> car トム n'est pas un 学生, mais アリス l'est.
Pour exprimer correctement le fait que アリス l'est et que トム ne l'est pas, une option est :

アリス：うん、<mark class=mint>でも</mark>トムは学生じゃない
...
<small>Bob : Qui est celui qui est étudiant ?</small>　
アリス：ジョン<mark class=green>が</mark>学生。
<small>Alice : John est celui qui est l'étudiant.</small>

---
Bob souhaite <u>identifier</u> qui est l'étudiant parmi plusieurs personnes potentielles. Alice identifie l'étudiant comme étant John.
<mark class=cyan>Note</mark> Alice aurait pu répondre avec une particule de thème pour dire que John est *un* étudiant (et non forcément *le* étudiant que Bob cherche)

<mark class=purple>Exemple</mark>
誰<mark class=green>が</mark>学生？
<small>Qui est celui qui est (l')étudiant ?</small>
学生<mark class=green>は</mark>誰？
...
Un adjectif est utilisé pour décrire un nom. Un adjectif peut directement modifier un nom qui le suis, ou aussi être connecté de la même façon que les noms et les particules.
...
<small>Personne silencieuse.</small>
きれい<mark class=green>な</mark>人。
...
<small>Bob aime le poisson.</small>
ボブは魚が<mark class=green>好きじゃない</mark>。
<small>Bob n'aime pas le poisson.</small>
ボブは魚が<mark class=green>好きだった</mark>。
<small>Bob aimait le poisson.</small>
...
<small>Personne qui aime le poisson.</small>
魚が<mark class=green>好きじゃない</mark>人。
<small>Personne qui n'aime pas le poisson.</small>
魚が<mark class=green>好きだった</mark>人。
<small>Personne qui aimait le poisson.</small>
...
On peut considérer l'ensemble de la clause nominale descriptive comme un seul nom.
On peut faire de la clause entière le thème.
...
<mark class=purple>Exemple</mark>
na-adj :
嫌い<mark class=green>な</mark>{食|た}べ{物|もの}。
<small>Nourriture détestée.</small>

i-adj :
おいしい食べ物。
<small>Nourriture délicieuse.</small>
...
<mark class=purple>Exemple</mark>
{値|ね}{段|だん}が高いレストランはあまりすきじゃない。
<small>N'aime pas beaucoup les prix élevés de ce restaurant.</small>
...
<mark class=purple>Exemple</mark>
値段があまり{良|よ}くない。
<small>Le prix n'est pas très bon.</small>
{彼|かれ}はかっこよかった！
<small>Il avait l'air vraiment cool !</small>

---
## 4 - Notions de base sur les verbes

### a - Le rôle des verbes

<mark class=mint>Remarque</mark>
Les verbes se situent tout le temps à la fin d'une clause, comme on ne sait pas encore créer plus d'une seule clause, cela signifie qu'ils seront à la fin d'une phrase. (si il y en a une)

Nous allons voir les 3 principales catégories de verbes
...
<mark class=purple>Exemple</mark>
食べる。
<small>Mange.(Traductions possibles : Je mange, Elle mange, Ils mangent)</small>

---
### b - Les verbes en -ru et verbes en -u
...
---
Il y aura toujours un dictionnaire pour savoir si un verbe est en -u ou en -ru.
Voici une liste de verbes communs (Les 2 seules exceptions inclus)

| ru-verb                                     | u-verb                    | exception       |
| ------------------------------------------- | ------------------------- | --------------- |
| {見\|み}る (regarder $\cancel{ \text{voir} }$) | {話\|はな}す (parler)         | する (faire)      |
| {食\|た}べる (manger)                           | {聞\|き}く(demander/écouter) | {来\|く}る (venir) |
| {寝\|ね}る(dormir)                             | {泳\|およ}ぐ (nager)          |                 |
| {起\|お}きる (se réveiller/se produire)         | {遊\|あそ}ぶ (jouer)          |                 |
...
Pour exprimer une action qui n'est pas effectuée, on conjugue les verbes plus ou moins comme les noms et les adjectifs.
...
>	1. する$\to$ しない
>	2. くる$\to$ こない
>	3. <span style="color:red">＊</span>ある$\to$ ない

Exemples de conjugaison de la forme négative
<mark class=purple>Exemple</mark>
...
<mark class=purple>Exemple</mark>
アリスは<u>食べない</u>。
<small>Alice ne mange pas.</small>
お{金|かね}が<mark class=green>ない</mark>。
<small>Il n'y a pas d'argent(Lit : l'argent est la chose qui n'existe pas).</small>
{猫|ねこ}は<mark class=green>いない</mark>。
<small>Il n'y a pas de chat(Lit: Quant au chat, n'existe pas).</small>
ボブも<mark class=green>しない</mark>。
<small>Bob aussi ne fait pas.</small>
...
<mark class=purple>Exemple</mark>
ご{飯|はん}は<mark class=green>食べた</mark>。
<small>Quant au repas, (je) l'ai mangé.</small>
{映|えい}{画|が}は、{全|ぜん}{部|ぶ}<mark class=green>見た</mark>。
<small>Quant au film, tout vu (J'ai vu tous les films).</small>
...
| Terminaison | Non-passé      | change en...                                                                        | Passé             |
| ----------- | -------------- | ----------------------------------------------------------------------------------- | ----------------- |
| す           | 話す             | す${\color{crimson}\to}$した                                                           | 話した               |
| く<br>ぐ      | 書く<br>泳ぐ       | く${\color{crimson}\to}$いた<br>ぐ${\color{crimson}\to}$いだ                              | 書いた<br>泳いだ        |
| む<br>ぶ<br>ぬ | 飲む<br>遊ぶ<br>死ぬ | む${\color{crimson}\to}$んだ<br>ぶ${\color{crimson}\to}$んだ<br>ぬ${\color{crimson}\to}$んだ | 飲んだ<br>遊んだ<br>死んだ |
| る<br>う<br>つ | 切る<br>買う<br>待つ | る${\color{crimson}\to}$った<br>う${\color{crimson}\to}$った<br>つ${\color{crimson}\to}$った | 切った<br>買った<br>待った |
...
| する        | した                                  |
| {来\|く}る   | {来\|き}た                             |
| 行く        | 行った<span style="color:red">＊</span> |

<mark class=purple>Exemple</mark>
今日は、<mark class=green>走った</mark>。
<small>Quant à aujourd'hui, (j'ai) couru.</small>
友達が<mark class=green>来た</mark>。
<small>Ami (est celui qui) est venu.</small>
私も<mark class=green>遊んだ</mark>。
<small>J'ai joué aussi.</small>
勉強は、<mark class=green>した</mark>。
<small>Quant au travail(étude), je l'ai fait.</small>
...
<mark class=purple>Exemple</mark>
アリスは食べな<mark class=green>かった</mark>。
<small>Quant à Alice, n'a pas mangé.</small>
私は買わなかった。
<small>Quant à moi, n'a pas acheté</small>
...
魚<mark class=green>を</mark>食べる。
<small>Manger poisson.</small>
 ジュース<mark class=green>を</mark>飲んだ。
 <small>(J'ai) Bu du jus.</small>
...
{街|まち}<mark class=green>を</mark>ぶらぶら{歩|ある}く。
<small>Marcher dans la ville sans but(Lit : sans but marcher ville)</small>
{高|こう}{速|そく}{道|どう}{路|ろ}<mark class=green>を</mark>{走|はし}る。
<small>Rouler sur l'autoroute (Lit : courir autoroute)</small>
<mark class=cyan>Note</mark> Le verbe 走る signifie courir, mais ici signifie rouler.
...
<small>Tous les jours, étudie la langue japonaise.</small>
メールアドレス<u>登録</u><small>(を)</small><u>した</u>。 ({登|とう}{録|ろく})
...
<small>Bob est allé au Japon.</small>
家<mark class=green>に</mark>{帰|かえ}らない。
<small>Ne pas rentrer à la maison.</small> 
部屋<mark class=green>に</mark>くる。
...
<small>Alice est venue des Etats-Unis.</small>
{宿|しゅく}{題|だい}を今日<mark class=green>から</mark>明日<mark class=green>まで</mark>する。
...
猫は部屋<mark class=green>に</mark>いる。
<small>Le chat est dans la pièce.</small>
いすが{台|だい}{所|どころ}<mark class=green>に</mark>あった。
<small>La chaise était dans la cuisine.</small>
いい友達<mark class=green>に</mark>会った。
...
1.　友達は、来年、日本に行く。
<small>L'année prochaine, ami ira au Japon</small>
2. 友達は、来年<mark class=green>に</mark>日本に行く。
...
<small>Bob s'est dirigé vers le Japon.</small>
家<mark class=green>へ</mark>帰らない。
<small>Ne rentre pas (chez soi) vers la maison.</small>
部屋<mark class=green>へ</mark>くる。
...
<small>Vu à la salle de cinéma.</small>
バス<mark class=green>で</mark>帰る。
<small>Rentrer à la maison par bus.</small>
レストラン<mark class=green>で</mark>{昼|ひる}ご{飯|はん}を食べる。
...
<small>Comment est-tu venu ?</small>
バス<mark class=green>で</mark>きた。
...
<mark class=purple>Exemple</mark>
{何|なん}できた？
<small>Pourquoi est-tu venu ?</small>
{暇|ひま}だから。
...
<mark class=purple>Exemple</mark>
ボブ：{学|がっ}{校|こう}に行った？
<small>Es-tu allée à l'école ?</small>
アリス：行かなかった。
<small>Je n'y suis pas allée.</small>
ボブ：図書館<mark class=green>には</mark>？
<small>Et à la bibliothèque ?</small>
アリス：図書館<mark class=green>に</mark>も行かなかった。
<small>Je ne suis pas allée à la bibliothèque également.</small>
...
<mark class=purple>Exemple</mark>
ボブ：どこで食べる？
<small>Manger où ?</small>
アリス：イタリアレストラン<mark class=green>では</mark>どう？
<small>Et un restaurant Italien, ça te dit ?</small>

Bob demande où manger et Alice suggère un restaurant Italien. 

<mark class=mint>Remarque</mark> Une phrase du type "Et un \[...], ça te dit ?" va habituellement amener à un nouveau thème, car la personne suggère quelque chose de nouveau.
Dans ce cas là, le lieu (restaurant) est en train d'être suggéré, donc il devient le thème.
...
<mark class=purple>Exemple</mark>
"Mettre dans la boîte"({箱|はこ}に{入|い}れる) vs. "Entrer dans la boîte"({箱|はこ}に{入|はい}る)

Cela vient uniquement des différences dans les langues
...
<mark class=cyan>Note</mark> Vu que la signification de base et le kanji est le même, on peut apprendre deux verbes pour le prix d'un seul kanji.

<mark class=grey>Définition</mark>
 >Verbe transitif $\to$ action directe
 >Verbe intransitif $\to$ action spontanée
 
 Voici une liste de verbes transitifs et intransitifs
<mark class=red>*</mark> $\to$ Il existe plusieurs prononciations pour le même mot avec des nuances différentes


| Transitif                                                                              | Intransitif                                                                                 |
| -------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| {落\|お}とす (Faire tomber)                                                                | {落\|お}ちる (Tomber)                                                                           |
| {出\|だ}す (Retirer)                                                                      | {出\|で}る (Sortir, partir)                                                                    |
| {入\|い}れる (Insérer)                                                                     | {入\|はい}る (Entrer)                                                                           |
| {開\|あ}ける (Ouvrir) [<mark class=red>*</mark>](https://kanjikana.com/en/kanji/%E9%96%8B) | {開\|ひら}く (Être ouvert) [<mark class=red>*</mark>](https://kanjikana.com/en/kanji/%E9%96%8B) |
| {閉\|し}める (Fermer)                                                                      | {閉\|し}まる (Être fermé)                                                                       |
| つける (Attacher)                                                                         | つく (Être attaché)                                                                           |
| {消\|け}す (Effacer)                                                                      | {消\|き}える (Disparaître)                                                                      |
| {抜\|ぬ}く (Extraire)                                                                     | {抜\|ぬ}ける (Être extrait)                                                                     |

---
#### Attention aux particules !

Ce qui est important de retenir ici, c'est comment utiliser la particule correcte pour le bon type de verbe.
Il se peut qu'il soit complexe de saisir la nuance initialement, pour distinguer lequel est lequel, ou bien même qu'il y ait une distinction transitif/intransitif tout court.

<mark class=cyan>Note</mark> Si vous n'êtes pas sûrs, il est toujours possible de vérifier si un verbe est transitif ou intransitif grâce à un [dictionnaire en ligne](https://jisho.org/)

<mark class=purple>Exemple</mark>
私が{電|でん}{気|き}<mark class=green>は</mark>つけた。
<small>Je suis celui/celle qui a allumé les lumières.</small>
電気<mark class=green>が</mark>ついた。
<small>Les lumières se sont allumées.</small>
電気<mark class=green>を</mark>消す。
<small>Eteins la lumière.</small>
電気<mark class=green>が</mark>消えす。
<small>Les lumières se sont éteintes.</small>
誰が{窓|まど}<mark class=green>を</mark>{開|あ}けた？
<small>Qui a ouvert la fenêtre ?</small>
窓<mark class=green>が</mark>どうして{開|ひら}いた？
<small>Pourquoi est-ce la fenêtre s'est ouverte ?</small>
...
<small>Quitté la pièce.</small>

---
## 7 - Clauses relatives et ordre des phrases

### a - Traiter les verbes et état-d'être comme adjectifs
...
---
<mark class=mint>Remarque</mark>
Cependant, on peut avoir une chaîne de noms placés ensemble quand ils ne sont pas destinés à se modifier les uns les autres.
...
---
<mark class=purple>Exemple</mark>
Ces exemples montrent des modifications de noms avec une clause de noms <u>conjugués</u> 

<mark class=green>学生じゃない</mark>人は、学校にいたない。
<small>La personne qui n'est pas étudiante ne va pas à l'école.</small>
<mark class=green>子共だった</mark>アリスが{立|りっ}{派|ぱ}な{大|お}{人|とな}になった。       ({子|こ}{共|ども})
<small>La Alice qui était une enfant est devenue une adulte remarquable.</small>
<mark class=green>友達じゃなかった</mark>アリスは、いい友達なった。
<small>Alice qui n'était pas une amie est devenue une bonne amie.</small>
<mark class=green>先週医者だった</mark>ボブは、{仕|し}{事|ごと}を{辞|や}めた。
<small>Bob qui était un docteur la semaine dernière, a démissioné (lit : a quitté son travail).</small>

---
### c - Utiliser les clauses relatives verbales comme des adjectifs

<mark class=cyan>Note</mark> Une clause relative verbale s'appelle proposition relative en français.

Les clauses verbales tout comme des adjectifs pour modifier des noms. Les exemples suivants vont nous montrer comment cela va nous permettre de créer des phrases complexes et détaillées. La clause verbale est mise en valeur

<mark class=purple>Exemple</mark>

<mark class=green>先週に映画を見た</mark>人は誰？
<small>Qui est la personne qui est allée au cinéma<small> (lit : qui a vu film.s)</small> la semaine dernière ?</small>
ボブは、<mark class=green>いつも勉強する</mark>人だ。
<small>Bob est quelqu'un qui étudie tout le temps.</small>
<mark class=green>赤いスボンを買う</mark>友達はボブだ。
<small>La personne qui achète des pantalons rouges est Bob.</small>
<mark class=green>夕食を食べなかった</mark>人は、<mark class=green>映画で見た</mark>{銀|ぎん}{行|こう}に行った。 ({夕|ゆう}{食|しょく})
...
<mark class=purple>Exemple</mark>
私は{公|こう}{園|えん}でお{弁|べん}{当|とう}を<mark class=green>食べた</mark>。
<small>Quant à moi, j'ai mangé ma lunch box au parc.</small>
公園で私はお弁当を<mark class=green>食べた</mark>。
<small>Quant à moi, j'ai mangé ma lunch box au parc.</small>
お弁当を私は公園で<mark class=green>食べた</mark>。
<small>Quant à moi, j'ai mangé ma lunch box au parc.</small>
弁当を<mark class=green>食べた</mark>。
<small>Mangé ma lunch box.</small>
<mark class=green>食べた</mark>。
<small>Mangé.</small> 

---
Ne stressez pas trop en vous demandant si la phrase est dans l'ordre correct. 
Rappelez vous juste des règles suivantes 
...
- <mark class=green>お弁当を食べた</mark>学生が公園に行った。
<small>L'étudiant qui a mangé sa lunch box est allé au parc.</small>

---
## 8 - Particules liées aux noms
...
<mark class=purple>Exemple</mark>
ナイフ<mark class=green>と</mark>フォークでステーキを食べた。
<small>Mangé le steak par moyen de couteau et fourchette.</small>
{本|ほん}<mark class=green>と</mark>{雑|ざっ}{誌|し}<mark class=green>と</mark>{葉|は}{書|がき}を買った。
...
<small>Parlé avec ami</small>
先生<mark class=green>と</mark>会った。
...
<mark class=purple>Exemple</mark>
飲み物<mark class=green>や</mark>カップ<mark class=green>や</mark>ナプキンは、いらない？
<small>Tu n'as pas besoin de (choses comme) une boisson, une tasse ou serviette etc... ?</small>

{靴|くつ}<mark class=green>や</mark>シャツを買う。
...
{靴|くつ}<mark class=green>とか</mark>シャツを買う。
<small>Acheter des (choses comme) des chausses, shirt, etc...</small>
...
<mark class=purple>Exemple</mark>
ボブ<mark class=green>の</mark>{本|ほん}。
<small>Livre de Bob.</small>
本<mark class=green>の</mark>ボブ。
<small>Bob de livre.</small>

La première phrase veut essentiellement dire "Le livre de Bob". 
...
<small>Bob est un étudiant de l'université des Etats-Unis.</small>

En français courant, ceci se traduirait vers "<small>Bob est un étudiant d'une université Américaine.</small>"
...
<mark class=purple>Exemple</mark>
Les noms répétitifs marqués ci dessous peuvent être omis

そのシャツは誰の<mark class=green>シャツだ</mark>？
<small>Cette chemise, à qui est cette chemise?</small>
ボブの<mark class=green>シャツだ</mark>。
<small>C'est la chemise de Bob.</small>

pour devenir

そのシャツは誰<mark class=green>の</mark>？
<small>Cette chemise, à qui est-elle ?</small>
ボブ<mark class=green>の</mark>だ。
...
<mark class=purple>Exemple</mark>
<mark class=green>白いの</mark>は、かわいい。 ({白|しろ}い)
<small>La chose qui est blanche est mignonne.</small>
<mark class=green>授業に行くの</mark>を{忘|わす}れた。({授|じゅ}{業|ぎょう})
<small>Oublié d'aller en cours.</small>
...
<small>La chose qui est blanche est mignonne.</small>
授業に行く<mark class=green>こと</mark>を忘れた　。
...
<mark class=green>毎日勉強する</mark>のは{大|たい}{変|へん}。 ({毎|まい}{日|にち})
<small>Le fait d'étudier tous les jours est difficile.</small>
<mark class=green>毎日同じ物を食べる</mark>のは、{面|おも}{白|しろ}くない。({同|おな}じ)
...
<small>La chambre silencieuse est la chambre d'Alice.</small>

devient :

静か<mark class=green>な</mark>のが、アリスの部屋だ。
<small>Celle silencieuse est la chambre d'Alice.</small>
...
<mark class=purple>Exemple</mark>
La phrase se formulerait ainsi :
...
<mark class=purple>Exemple</mark>
ジムのだ。
<small>C'est à Jim.</small>
ジム<mark class=green>な</mark>のだ。
<small>C'est Jim (avec un ton explicatif).</small>

Hormis ce cas, tout reste comme précédemment.
